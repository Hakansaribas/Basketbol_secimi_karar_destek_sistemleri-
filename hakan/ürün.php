...
<div class="üst"> <br><center> <font size=6 color=white face='Cursive'> ANALİZ</font></center>
</div>
<div class="sidebar"> 
...
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Oyun Kurucu' AND istatistik.puan >= 7  
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Kısa Forvet' AND istatistik.puan >= 7  
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'uzun Forvet' AND istatistik.puan >= 7  
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Pivot' AND istatistik.puan >= 7  
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
