...
if($baglanti){
    if ($_POST) {
		...
		if(strip_tags(trim(isset($_POST["transfer"])))){
        ...
        $sorgu=mysqli_query($baglanti,"INSERT INTO oyuncu(sporcu_id,ad,soyad,yas,takim_id,mevki_id,boy,kilo,transfer) VALUES
            ('".$sporcu_id."','".$ad."','".$soyad."','".$yas."','".$takim_id."','".$mevki_id."','".$boy."','".$kilo."','".$transfer."')");
        if ($sorgu==true) {
