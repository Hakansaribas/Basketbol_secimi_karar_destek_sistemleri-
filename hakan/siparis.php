...
<div class="üst"> <br><center> <font size=6 color=white face='Cursive'> KEŞFET  </font></center>
</div>
...
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  OYUN KURUCU </b></td>
<br>
	<tr>
...
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Oyun Kurucu' AND istatistik.puan >= 7 AND oyuncu.yas < 25
...
<table border="0" width='800px' height='50px' align="center"> 
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  SUTOR GORD </b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>Ad Soyad</th>
		<th bgcolor="#E6EE9C"><i>Yaş</th>
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Sutor Gard' AND istatistik.puan >= 7  
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
...
<table border="0" width='800px' height='50px' align="center"> 
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  KISA FORVET </b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>Ad Soyad</th>
		<th bgcolor="#E6EE9C"><i>Yaş</th>
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Kısa Forvet' AND istatistik.puan >= 7  AND oyuncu.yas <= 25
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
...
?>
<table border="0" width='800px' height='50px' align="center"> 
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  UZUN FORVET</b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>Ad Soyad</th>
		<th bgcolor="#E6EE9C"><i>Yaş</th>
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'uzun Forvet' AND istatistik.puan >= 7  AND oyuncu.yas <= 25
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
...
<table border="0" width='800px' height='50px' align="center"> 
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  PİVOT </b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>Ad Soyad</th>
		<th bgcolor="#E6EE9C"><i>Yaş</th>
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas, oyuncu.boy, oyuncu.kilo, takim.takim_ad, istatistik.puan
FROM oyuncu, istatistik, takim, mevki
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND oyuncu.mevki_id = mevki.mevki_id AND mevki.mevki_ad = 'Pivot' AND istatistik.puan >= 7 AND oyuncu.yas <= 25 
ORDER BY istatistik.puan";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
