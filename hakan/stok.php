...
<div class="üst"> <br><center> <font size=6 color=white face='Cursive'> TAKIMIM  </font></center>
</div>
<div class="sidebar"> 
...
<td align=center colspan="5"> <font size=4 color=blue face='Cursive'> <b>  DENVER NUGGETS </b></td>
<br>
	<tr>
...
$sql="SELECT oyuncu.ad, oyuncu.soyad, oyuncu.yas,oyuncu.boy, oyuncu.kilo, mevki.mevki_ad 
FROM oyuncu, mevki,takim
WHERE oyuncu.mevki_id=mevki.mevki_id AND oyuncu.takim_id=takim.takim_id AND takim.takim_ad='Denver Nuggets'";
...
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	...
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["mevki_ad"]."</td>";
...
<table border="0" width='800px' height='50px' align="center"> 
<td align=right colspan="5"> <font size=4 color=blue face='Cursive'> <b> OYUNCU İSTATİSTİĞİ </b></td>
<br>
	<tr>
		<th bgcolor="#E6EE9C"><i>Ad Soyad</th>
		<th bgcolor="#E6EE9C"><i>Ribound</th>
		<th bgcolor="#E6EE9C"><i>Blok</th>
		<th bgcolor="#E6EE9C"><i>Asist</th>
		<th bgcolor="#E6EE9C"><i>Sayı</th>
		<th bgcolor="#E6EE9C"><i>Top Çalma</th>
		<th bgcolor="#E6EE9C"><i>Üç Sayılık</th>
		<th bgcolor="#E6EE9C"><i>Süre</th>
...
$baglanti->set_charset("utf8");
//echo "<table border='1' width='900px' height='600px' align='center'>";
$sql="SELECT oyuncu.ad, oyuncu.soyad, istatistik.ribaund, istatistik.blok, istatistik.asist,istatistik.sayi, istatistik.top_calma, istatistik.uc_sayilik, istatistik.sure, istatistik.puan
FROM oyuncu, istatistik,takim
WHERE oyuncu.sporcu_id = istatistik.sporcu_id AND oyuncu.takim_id = takim.takim_id AND takim.takim_ad ='Denver Nuggets'";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["ad"]." ".$sonuc["soyad"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["ribaund"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["blok"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["asist"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["sayi"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["top_calma"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["uc_sayilik"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["sure"]."</td>";
